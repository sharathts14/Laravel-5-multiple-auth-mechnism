 ...
 * author: Sharath TS
 * date: 2/17/2016
 * email:sharath.ts@gmail.com
 * changes made: remove all "required_once" & "include_once" and use laravel's "namespace" and "use"**/
namespace App\Http\Libraries\adLDAP;

use App\Http\Libraries\adLDAP\collections\adLDAPCollection;
use App\Http\Libraries\adLDAP\adClasses\adLDAPGroups;
use App\Http\Libraries\adLDAP\adClasses\adLDAPUsers;
use App\Http\Libraries\adLDAP\adClasses\adLDAPFolders;
use App\Http\Libraries\adLDAP\adClasses\adLDAPUtils;
use App\Http\Libraries\adLDAP\adClasses\adLDAPContacts;
use App\Http\Libraries\adLDAP\adClasses\adLDAPExchange;
use App\Http\Libraries\adLDAP\adClasses\adLDAPComputers;
use App\Http\Libraries\adLDAP\adLDAPException;

/*
include_once('/collections/adLDAPCollection.php');
include_once('/adClasses/adLDAPGroups.php');
include_once('/adClasses/adLDAPUsers.php');
include_once('/adClasses/adLDAPFolders.php');
include_once('/adClasses/adLDAPUtils.php');
include_once('/adClasses/adLDAPContacts.php');
include_once('/adClasses/adLDAPExchange.php');
include_once('/adClasses/adLDAPComputers.php');
*/
...
class adLDAP {
    ...
    */
    const ADLDAP_LDAP_PORT = '3268';
    /**
    * The default port for LDAPS SSL connections
    */
    const ADLDAP_LDAPS_PORT = '3268';
    ...
    * @var string
    */   
	protected $accountSuffix = "@your.domain.suffix";
    ...
    * @var string
    */
	protected $baseDn = "DC=your.domain.controller.name";
    ...
    * @var array
    */
    protected $domainControllers = array("your.domain.controller.name");
